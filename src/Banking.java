...
public class Banking
{
    ...
    public Area getClosestBank(Area closestBank)
    {
        closestBank = null;
        Area[] banks =
                {
    ...
    public boolean depositAllFish(List<String> list)
    {
        ...
        for(int i = 0; i < count; i ++)
        {
            ...
            if(this.script.inventory.contains("Nature " + item))
            {
                this.script.bank.deposit("Nature " + item, MethodProvider.random(28,60));
                continue;
            }
            else
            if(this.script.inventory.contains("Nature " + item + "s"))
            {
                this.script.bank.deposit("Nature " + item + "s", MethodProvider.random(28,60));
                continue;
            }
        }
        return true;
